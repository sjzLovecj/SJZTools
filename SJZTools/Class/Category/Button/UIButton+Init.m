...
/**
 创建button，文本、字体、文字颜色（默认）、图片（默认）、背景颜色、圆角、父视图
...
+ (instancetype)buttonWithTitle:(NSString *)title
                  ...
                  complete:(buttonComplete)complete
                   touchUpBlock:(touchUpBlock)touchUpBlock {
    return [UIButton buttonWithTitle:title norColor:norColor heiColor:nil font:font norImage:norImage heiImage:nil backColor:backColor superView:superView complete:complete touchUpBlock:touchUpBlock];
}


/**
 创建button，文本、字体、文字颜色（默认）、图片（默认）、背景颜色、描边宽度、描边颜色、圆角、父视图
...
+ (instancetype)buttonWithTitle:(NSString *)title
                  ...
                  complete:(buttonComplete)complete
                   touchUpBlock:(touchUpBlock)touchUpBlock {
    return [UIButton buttonWithTitle:title norColor:norColor heiColor:heiColor selColor:nil font:font norImage:norImage heiImage:heiColor selImage:nil backColor:backColor borderWidth:0 borderColor:nil cornerRadius:0 superView:superView complete:complete touchUpBlock:touchUpBlock];
}
...
+ (instancetype)buttonWithTitle:(NSString *)title
                  ...
                  complete:(buttonComplete)complete
                   touchUpBlock:(touchUpBlock)touchUpBlock {
    return [UIButton buttonWithTitle:title norColor:norColor selColor:selColor font:font norImage:norImage selImage:selImage backColor:backColor borderWidth:0 borderColor:nil cornerRadius:0 superView:superView complete:complete touchUpBlock:touchUpBlock];
}
